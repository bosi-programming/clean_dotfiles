...
" Make yy to accept selected completion item or notify coc.nvim to format
" <C-g>u breaks current undo, please make your own choice.
inoremap <silent><expr> yy coc#pum#visible() ? coc#pum#confirm()
...
" Use <leader>lh to show documentation in preview window
...
" Show commands.
nnoremap <silent><nowait> <leader>ca  :<C-u>CocList commands<cr>
" Do default action for next item.
nnoremap <silent><nowait> <leader><right>  :<C-u>CocNext<CR>
" Do default action for previous item.
nnoremap <silent><nowait> <leader><left>  :<C-u>CocPrev<CR>
